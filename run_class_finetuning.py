...
def get_args():
    ...
    # Finetuning params
    parser.add_argument('--finetune', default=r'C:\Users\ZK\.cache\torch\hub\checkpoints\checkpoint.pth', help='finetune from checkpoint')
    ...
    parser.add_argument('--output_dir', default=r'./out',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default=r'./out',
